...
import net.fkt.forgetrain.entity.custom.TomahawkProjectileEntity;
...
public class TomahawkProjectileModel extends EntityModel<TomahawkProjectileEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ForgeTrain.MOD_ID, "tomahawk"), "main");
